      ...
      <div class="row">
        <div class="col-md">
          ...
          <div class="card card-dark">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <div class="flash-data" data-status="danger" data-flashdata="<?= $this->session->flashdata('message'); ?>"></div>
              <!-- <div class="flash-data" data-status="danger" data-flashdata="Test"></div> -->
