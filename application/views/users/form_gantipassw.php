          ...
          <div class="card card-dark">
            ...
            <form role="form" method="POST" action="">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="gantipassw">Password Baru</label>
                  <input type="text" class="form-control col-md-4" id="gantipassw" name="gantipassw" placeholder="Enter Password Baru" value="">
                  <small class="form-text text-danger"><?= form_error('gantipassw'); ?></small>
                </div>
              </div>
              <!-- /.card-body -->
