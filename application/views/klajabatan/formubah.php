        ...
        <div class="col-md">
          ...
          <div class="card card-dark">
            ...
            <form role="form" method="POST" action="">
              <div class="card-body">
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $kljbt['kode_kj']; ?>">
                <div class="form-group">
                  <label for="kdjabtan">Kode Jabatan</label>
                  <input type="text" class="form-control col-md-3" id="kdjabtan" name="kdjabtan" placeholder="Enter Kode Jabatan" value="<?= $kljbt['kode_kj']; ?>" readonly>
